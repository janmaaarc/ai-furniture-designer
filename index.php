...
function generate_options(array $options, string $selectedValue = ''): void {
    foreach ($options as $option) {
        $encodedOption = htmlspecialchars($option, ENT_QUOTES | ENT_HTML5, 'UTF-8');
        $encodedSelectedValue = htmlspecialchars($selectedValue, ENT_QUOTES | ENT_HTML5, 'UTF-8');
        $selected = ($encodedSelectedValue === $encodedOption) ? 'selected' : '';
...
function render_icon(string $name): void {
    $icons = [
        'furniture' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 9V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v3"/><path d="M2 11h20"/><path d="M3 11v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6"/><path d="M4 18v-2"/><path d="M20 18v-2"/></svg>',
        'price' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82-.71-.71z"/></svg>',
...
<body>
            ...
            <div class="card-body">
                <div class="form-container" id="form-container">
                    ...
                    <form id="furniture-form" novalidate>
                        ...
                        <button type="button" id="generate-btn" class="btn btn-primary btn-lg w-100 mt-4 cta-button">
    ...
    <script>
        window.N8N_WEBHOOK_URL = '<?php echo getenv("N8N_WEBHOOK_URL"); ?>';
    </script>
